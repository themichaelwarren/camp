...
const Dashboard: React.FC<DashboardProps> = ({ prompts, assignments, submissions, onNavigate }) => {
  const stats = [
    ...
    { label: 'Campers Active', value: 24, icon: 'fa-users', color: 'bg-purple-100 text-purple-600', view: 'dashboard' },
  ];
